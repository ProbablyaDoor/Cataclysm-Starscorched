...
public class EntityLightRenderHandler {
    ...
    public static void renderEntityLight(LivingEntity entity, float f, float g, MatrixStack matrixStack, double[] translation,
                                        VertexConsumerProvider vertexConsumerProvider, int i, int lifeTime, int[] rgbColorOne, int[] rgbColorTwo, int[] rgbColorThree, int[] rgbColorFour) {
        if (lifeTime > 0) {
            float l = ((float)lifeTime + g) / 200.0f;
