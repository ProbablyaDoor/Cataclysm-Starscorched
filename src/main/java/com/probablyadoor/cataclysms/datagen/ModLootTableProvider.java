...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(ModBlocks.TESTING_BLOCK_REINFORCED);

        addDrop(ModBlocks.STARSCORCHED_SLATE, multipleOreDrops(ModBlocks.STARSCORCHED_SLATE, ModItems.STARMETAL_SCRAP, 1, 3));
